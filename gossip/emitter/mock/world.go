...
// Source: github.com/sesanetwork/go-sesa/gossip/emitter (interfaces: External,TxPool,TxSigner,Signer)
...
import (
	...
	native "github.com/sesanetwork/go-sesa/native"
	validatorpk "github.com/sesanetwork/go-sesa/native/validatorpk"
	sesa "github.com/sesanetwork/go-sesa/sesa"
	vecmt "github.com/sesanetwork/go-sesa/vecmt"
)
...
func (m *MockExternal) GetRules() sesa.Rules {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRules")
	ret0, _ := ret[0].(sesa.Rules)
	return ret0
}
